    ...
    <div className="container py-16">
      <div className="grid lg:grid-cols-3 gap-12">
        <div className="lg:col-span-1">
          <div className="space-y-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg animate-pulse">
              <div className="h-6 bg-steel-200 rounded mb-6"></div>
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-steel-200 rounded-lg mr-4"></div>
                  <div>
                    <div className="h-4 bg-steel-200 rounded mb-1 w-24"></div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-2xl p-8 shadow-lg animate-pulse">
            <div className="h-6 bg-steel-200 rounded mb-8 w-48"></div>
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="h-10 bg-steel-200 rounded"></div>
                <div className="h-10 bg-steel-200 rounded"></div>
              </div>
            </div>
          </div>
